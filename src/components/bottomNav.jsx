export default function BottomNav({ current = 'workout', onChange }) {
    const is = (id) =>
        current === id ? 'text-teal-600' : 'text-gray-500 hover:text-teal-600'
    ...
    return (
        <nav className="h-16 z-50 border-t border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/70">
            <div className="mx-auto h-16 max-w-xl px-2">
                <div className="grid h-full grid-cols-3 items-center">
                    ...
                    <div className="flex justify-center">
                        <button
                            ...
                            aria-current={
                                current === 'workout' ? 'page' : undefined
                            }
