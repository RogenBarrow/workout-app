    ...
    async function onSubmit(values) {
        try {
            await addDoc(collection(db, 'workouts'), {
                ...
                sets: values.sets,
                reps: values.reps,
                weightKg: Number.isFinite(values.weightKg)
                    ? values.weightKg
                    : 0,
    ...
    return (
        ...
        >
            ...
            <div className="pt-0">
                ...
                {errors.date && (
                    <small className="mt-1 block text-sm text-red-600">
                        {errors.date.message || 'Invalid value'}
                    </small>
                )}
            </div>
            ...
            <div className="pt-6">
                ...
                {errors.exercise && (
                    <small className="mt-1 block text-sm text-red-600">
                        {errors.exercise.message || 'Invalid value'}
                    </small>
                )}
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
                <div className="pt-6">
                    ...
                    {errors.sets && (
                        <small className="mt-1 block text-sm text-red-600">
                            {errors.sets.message || 'Invalid value'}
                        </small>
                    )}
                </div>
                ...
                <div className="pt-6">
                    ...
                    {errors.reps && (
                        <small className="mt-1 block text-sm text-red-600">
                            {errors.reps.message || 'Invalid value'}
                        </small>
                    )}
                </div>
                ...
                <div className="pt-6">
                    ...
                    {errors.weightKg && (
                        <small className="mt-1 block text-sm text-red-600">
                            {errors.weightKg.message || 'Invalid value'}
                        </small>
                    )}
                </div>
            </div>
